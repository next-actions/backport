...
envlist='$PR_ID,$PR_URL,$PR_TITLE,$PR_URL,$PR_BODY,$PR_AUTHOR,$PR_COMMITS,$MERGE_COMMITS,$TARGET,$FORK_USER,$REPOSITORY,$BACKPORT_BRANCH_NAME,$BACKPORT_COMMITS,$CONFLICT_INFORMATION'
